import sys, os, threading, time, math, random, queue
...
# Gesture table — core signs first
GTABLE = [
...
def ui_top(img, words, sign, state, prog, t):
    ...
    ti="Sign Language to Voice AI"; tw2,_=tsz(ti,0.38)
...
def main():
    print("\n╔══════════════════════════════════════╗")
    print("║        Sign Language to Voice AI     ║")
    print("╚══════════════════════════════════════╝")
    print()
    print("  SUPPORTED CORE SIGNS:")
    print("  peace-V       → USE")
    ...
    cv2.namedWindow("Sign Language to Voice AI", cv2.WINDOW_NORMAL)
    cv2.resizeWindow("Sign Language to Voice AI", 1280, 720)
    ...
    cv2.setMouseCallback("Sign Language to Voice AI",mouse_cb,[1280])
    ...
    while True:
        ...
        cv2.imshow("Sign Language to Voice AI",dark)
